describe('data', () => {
  ...
  describe('sortUsers(users, orderBy, orderDirection)', () => {
    ...
    const studentA = {
      name: "ALIDA DEL ROSARIO CONTRERAS TRUEVAS",
      stats: {
        exercises: {
          completed: 1,
          percent: 100,
    ...
    it('debería retornar arreglo de usuarios ordenado por nombre ASC', () => {
      assert.deepEqual(sortUsers(students, "name", "Ascendente"), [studentA, studentB, studentC])
    });
    it('debería retornar arreglo de usuarios ordenado por nombre DESC', () => {
      assert.deepEqual(sortUsers(students, "name", "Descendente"), [studentC, studentB, studentA])
    });
    it('debería retornar arreglo de usuarios ordenado por porcentaje general ASC', () => {
      assert.deepEqual(sortUsers(students, "completitud", "Ascendente"), [studentA, studentB, studentC])
    });
    it('debería retornar arreglo de usuarios ordenado por porcentaje general DESC', () => {
      assert.deepEqual(sortUsers(students, "completitud", "Descendente"), [studentC, studentB, studentA])
    });
    it('debería retornar arreglo de usuarios ordenado por ejercicios completados ASC', () => {
      assert.deepEqual(sortUsers(students, "ejercicios", "Ascendente"), [studentA, studentB, studentC])
    });
    it('debería retornar arreglo de usuarios ordenado por ejercicios completados DESC', () => {
      assert.deepEqual(sortUsers(students, "ejercicios", "Descendente"), [studentC, studentB, studentA])
    });
    it('debería retornar arreglo de usuarios ordenado por quizzes completados ASC', () => {
      assert.deepEqual(sortUsers(students, "quizzes", "Ascendente"), [studentA, studentB, studentC])
    });
    it('debería retornar arreglo de usuarios ordenado por quizzes completados DESC', () => {
      assert.deepEqual(sortUsers(students, "quizzes", "Descendente"), [studentC, studentB, studentA])
    });
    ...
    it('debería retornar arreglo de usuarios ordenado por lecturas (reads) completadas ASC', () => {
      assert.deepEqual(sortUsers(students, "lecturas", "Ascendente"), [studentA, studentB, studentC])
    });
    it('debería retornar arreglo de usuarios ordenado por lecturas (reads) completadas DESC', () => {
      assert.deepEqual(sortUsers(students, "lecturas", "Descendente"), [studentC, studentB, studentA])
    });
